Public Class GradeComputation
    Private Sub btnComputeGrade_Click(sender As Object, e As EventArgs) Handles btnComputeGrade.Click
        ...
        If Integer.TryParse(txtCalculus.Text, num1) And Integer.TryParse(txtDSA.Text, num2) And Integer.TryParse(txtLinearAlgebra.Text, num3) And Integer.TryParse(txtOOP.Text, num4) Then
